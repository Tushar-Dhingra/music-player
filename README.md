<div align="center">
  ...
  <a href="https://tushar-dhingra.github.io/music-player/"><strong>➥ Live Demo</strong></a>
...
```bash
sudo git clone https://github.com/Tushar-Dhingra/music-player.git
```

Windows:

```bash
git clone https://github.com/Tushar-Dhingra/music-player.git
```

### Contact

If you want to contact with me you can reach me at [Mail](tushardhingra808@gmail.com).
